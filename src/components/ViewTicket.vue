...
const fetchMessages = async () => {
  const token = localStorage.getItem('token')
  try {
    const res = await fetch(`https://vswiftsupport.gov.vc/api/tickets/${ticketId}/messages`, {
      headers: {
        Authorization: 'Bearer ' + token,
        'Content-Type': 'application/json',
      },
...
const sendMessage = async () => {
  ...
  try {
    const res = await fetch(`https://vswiftsupport.gov.vc/api/tickets/${ticketId}/message`, {
      method: 'POST',
      headers: {
        Authorization: 'Bearer ' + token,
        'Content-Type': 'application/json',
