...
export default {
 ...
 const fetchUserPermissions = async () => {
      ...
      try {
          ...
          const response = await fetch('http://vswiftsupporttest.gov.vc/api/user-permissions',
        {
                    headers: {
     ...
     const handleAddUserPermission = async () => {
      try {
        ...
        const response = await fetch('http://vswiftsupporttest.gov.vc/api/user-permissions/create', {
          method: 'POST',
          headers: {
            'Authorization': 'Bearer '+ token,
            'Content-Type': 'application/json'
     ...
     const handleDeleteUserPermission = async (perid) => {
      ...
      try {
        const token = localStorage.getItem('token');
        const response = await fetch(`http://vswiftsupporttest.gov.vc/api/user-permissions/${perid}`, {
          method: 'DELETE',
           headers: {
            'Authorization': 'Bearer '+ token,
            'Content-Type': 'application/json'
 ...
 const fetchUserRoles = async () => {
      ...
      try {
          ...
          const response = await fetch('http://vswiftsupporttest.gov.vc/api/user-roles',
        {
                    headers: {
                        "Authorization": "Bearer "+ token,
                         "Content-Type": "application/json"
