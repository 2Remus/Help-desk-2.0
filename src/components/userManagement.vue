...
export default {
  ...
  const auth = useAuthStore();
    ...
    const fetchUsers = async () => {
      try {
        ...
        const response = await fetch('https://vswiftsupport.gov.vc/api/users',
                     {
                    headers: {
    ...
    const handleAddUser = async () => {
      try {
        const token = localStorage.getItem('token');
        const response = await fetch('https://vswiftsupport.gov.vc/api/users/create', {
          method: 'POST',
          headers: {
            'Authorization': 'Bearer '+ token,
            'Content-Type': 'application/json'
    ...
    const handleDeleteUser = async (userId) => {
      ...
      try {
        const token = localStorage.getItem('token');
        const response = await fetch(`https://vswiftsupport.gov.vc/api/users/change/${userId}`, {
          method: 'DELETE',
          headers: {
            'Authorization': 'Bearer '+ token,
            'Content-Type': 'application/json'
    ...
    const handleRoleChange = async (user) => {
      try {
        const token = localStorage.getItem('token');
        const response = await fetch(`https://vswiftsupport.gov.vc/api/users/edit/role/${user.id}`, {
          method: 'PUT',
          headers: {
            'Authorization': 'Bearer '+token,
            'Content-Type': 'application/json'
    ...
    const handleIssueTypeChange = async (user) => {
     ...
     const handleActiveStatusChange = async (user) => {
      try {
        const token = localStorage.getItem('token');
        const response = await fetch(`https://vswiftsupport.gov.vc/api/users/edit/activeStatus/${user.id}`, {
          method: 'PUT',
          headers: {
            'Authorization': 'Bearer '+token,
            'Content-Type': 'application/json'
 ...
 const fetchInstitutions = async () => {
      try {
        ...
        const response = await fetch('https://vswiftsupport.gov.vc/api/institutions',
        {
                    headers: {
                        "Authorization": "Bearer "+ token,
                         "Content-Type": "application/json"
    ...
    const handleLogout = () => {
     ...
     const fetchUserRoles = async () => {
      ...
      try {
          ...
          const response = await fetch('https://vswiftsupport.gov.vc/api/user-roles',
        {
                    headers: {
                        "Authorization": "Bearer "+ token,
                         "Content-Type": "application/json"
